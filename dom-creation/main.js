...
const renderPokemon = pokemon => {
  ...
  pokemonDiv.setAttribute('class', 'pokemon-card');
  pokeImg.setAttribute('src', `${pokemon.imageUrl}`);
  cardTxt.setAttribute('class', 'pokemon-card-text');

  pokeName.textContent = `${pokemon.name}`;
  pokeNumber.textContent = `${pokemon.number}`;
  pokeDescription.textContent = `${pokemon.description}`;

  firstDiv.appendChild(pokemonDiv);
  pokemonDiv.appendChild(pokeImg);
  pokemonDiv.appendChild(cardTxt);
  cardTxt.appendChild(pokeName);
  cardTxt.appendChild(pokeNumber);
  cardTxt.appendChild(pokeDescription);
